                ...
                <div className="container px-4 md:px-6">
                    <div className="flex flex-col items-center space-y-6">
                        <div className="space-y-4 text-center">
                            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl sm:mt-20 lg:text-7xl xl:text-8xl bg-clip-text text-transparent bg-gradient-to-r from-gray-900 dark:from-white via-blue-400 dark:via-blue-400 to-purple-400 dark:to-purple-400">
