...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full boder border-transparent backdrop-blur-md dark:border-white/[0.2] shadow-input flex justify-center space-x-4 px-8 py-6 "
    >
      {children}
    </nav>
  );
...
export const HoveredLink = ({ children, ...rest }: any) => {
  return (
    <Link
      {...rest}
className=" dark:text-white text-gray-800 transition-all duration-500 ease-in-out hover:bg-clip-text hover:text-transparent hover:bg-gradient-to-r hover:from-blue-300 hover:via-blue-300 hover:to-purple-400"    >
      {children}
    </Link>
  );
};
